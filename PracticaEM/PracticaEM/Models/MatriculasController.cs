...
namespace PracticaEM.Models
{
    public class MatriculasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MatriculaId,Mail,Ano,Nombre,UserId,GrupoClaseId,CursoId")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MatriculaId,Mail,Ano,Nombre,UserId,GrupoClaseId,CursoId")] Matricula matricula)
        {
            if (ModelState.IsValid)
            {
